...
class single_llist
{
    public:
        ...
        void reverse();
        void display();
        node * reverse_recursion(node *start);
        single_llist()
        {
            start = NULL;
        }
...
int main(){
    ...
    while (1)
    {
        ...
        cout<<"10.Exit "<<endl;
        cout<<"11.Reverse (Recursion) "<<endl;
        ...
        case 10:
            ...
            break;
        case 11:
            cout<<"Reverse elements of Link List recursively"<<endl;
            temp1 = sl.reverse_recursion(start);
            cout<<"Linked list reversed ! New Head is "<<temp1->value<<endl;
            start = temp1;
            cout<<endl;
            break;
        default:
...
node * single_llist::reverse_recursion(node *head)
{
    node *newHead;
    if(head == NULL){
        return NULL;
    ...
    if(head->next != NULL){
        ...
        head->next = NULL;
        newHead = reverse_recursion(nextE);
        nextE->next = head;
    }else{
        return head;
    }
